...
#		runzip=True
	...
	os.system(SAMTOOLS_DIR+"samtools faidx "+options.genes)
	os.system(SMALT_DIR+" index -k 13 -s 2 "+options.genes+".index "+options.genes)
	...
	os.system(SMALT_DIR+" map -y 0.5 -d 0 -f samsoft -o "+tmpname+".sam "+options.genes+".index "+options.forward+" "+options.reverse)
	os.system(SAMTOOLS_DIR+"samtools view -F 4 -b -S "+tmpname+".sam -t "+options.genes+".fai > "+tmpname+".1.bam")
