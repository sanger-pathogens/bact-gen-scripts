...
if __name__ == "__main__":
	...
	print "To continue to use the old map_resistome script, use /nfs/pathogen/sh16_scripts/map_resistome_deprecated.py"
	sys.exit()
	...
	os.system("/nfs/pathogen/sh16_scripts/filter_resistome.py -i "+str(options.id)+" -c "+options.output+"_no_Ns.fasta -b "+options.output+".bam -g "+options.genes+" -o "+options.output+" -f "+options.forward+" -r "+options.reverse)
