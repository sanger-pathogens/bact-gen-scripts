...
if __name__=="__main__":
	...
	if precisionfile!="":
		...
		if len(precisiondict)!=0:
			...
			if taxanode==None:
				...
				for taxonblock in taxanode.findall('taxon'):
					...
					if taxon_name in precisiondict:
						print taxon_name, dateblock.attrib["value"], precisiondict[taxon_name]
			...
			#Need to copy treeModelnode and add a leafHeight block for each taxon in added_precision_to list
