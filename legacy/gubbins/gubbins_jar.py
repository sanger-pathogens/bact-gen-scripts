...
pcs4_RAxML_DIR="/software/pathogen/external/apps/usr/bin/raxmlHPC-8.2.8"
farm3_RAxML_DIR="/software/pathogen/external/apps/usr/bin/raxmlHPC-8.2.8"
...
#	sys.exit()
	...
	#				print >> handle, record.seq[f:]
		...
		if (options.runtree or options.tree=="") or iteration>1:
			...
			if iteration==1:
				options.tree=prefix+"_Current.tre"
				treeinfofile="RAxML_info.SNPS_"+prefix
			else:
				...
				options.tree="RAxML_result.ALLSNPS_"+prefix
...
#		print newtree
		...
		os.system("/nfs/pathogen/sh16_scripts/gubbins/jar.py AllSNPS_"+prefix+".aln "+options.tree+" "+treeinfofile)
...
#	os.system("mv "+prefix+"_iteration"+str(iteration)+".tre "+prefix+"_Final.tre")
	if options.reference=="":
		if options.outgroup!="":
			os.system("/nfs/pathogen/sh16_scripts/iCANDY.py -q taxa -M -L right -t "+prefix+"_Final.tre -o "+prefix+"_Final_recomb "+prefix+"_rec.tab")
		else:
			os.system("/nfs/pathogen/sh16_scripts/iCANDY.py -q taxa -L right -t "+prefix+"_Final.tre -o "+prefix+"_Final_recomb "+prefix+"_rec.tab")
	else:
		if options.outgroup!="":
			os.system("/nfs/pathogen/sh16_scripts/iCANDY.py -q taxa -M  -L right-t "+prefix+"_Final.tre -o "+prefix+"_Final_recomb "+options.reference+" "+prefix+"_rec.tab")
		else:
			os.system("/nfs/pathogen/sh16_scripts/iCANDY.py -q taxa -L right -t "+prefix+"_Final.tre -o "+prefix+"_Final_recomb "+options.reference+" "+prefix+"_rec.tab")
