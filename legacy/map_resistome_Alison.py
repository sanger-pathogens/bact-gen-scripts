...
if __name__ == "__main__":
	...
	os.system("/nfs/pathogen/sh16_scripts/filter_resistome_Alison.py -i "+str(options.id)+" -c "+options.output+"_no_Ns.fasta -b "+options.output+".bam -g "+options.genes+" -o "+options.output+" -f "+options.forward+" -r "+options.reverse)
