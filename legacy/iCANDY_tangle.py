...
sys.path.extend(map(os.path.abspath, ['/nfs/pathogen/sh16_scripts/modules/Tangled-master']))
...
def read_dendropy_tree(treefile):
		...
		#And to make it reroot properly if the tree is already rooted on the midpoint
