...
#				print >> bashfile, "/nfs/users/nfs_t/tdo/Bin/join.solexa2pairs.v2.pl "+self.fastqdir+self.name+"_1.fastq "+self.fastqdir+self.name+"_2.fastq "+self.runname+"/shuffled.tmp"
				#nameprefixone='_'.join(self.name.split('_')[:2])+"_1_"+self.name.split('_')[-1]
				if multiplexnamed=='y':
					print >> bashfile, "/nfs/users/nfs_t/tdo/Bin/join.solexa2pairs.v2.pl "+self.fastqdir+'_'.join(self.name.split('_')[:2])+"_1_"+self.name.split('_')[-1]+".fastq "+self.fastqdir+'_'.join(self.name.split('_')[:2])+"_2_"+self.name.split('_')[-1]+".fastq "+self.runname+"/shuffled.tmp"
				else:
					print >> bashfile, "/nfs/users/nfs_t/tdo/Bin/join.solexa2pairs.v2.pl "+self.fastqdir+self.name+"_1.fastq "+self.fastqdir+self.name+"_2.fastq "+self.runname+"/shuffled.tmp"
				print >> bashfile, "/nfs/users/nfs_s/sh16/ssaha_2.2/ssaha2 -"+self.rtype+" -score "+str(self.quality)+" -skip 2 -diff 0 -output cigar "+ref+" "+self.runname+"/shuffled.tmp > "+self.runname+"/cigar1.tmp"
			
#			print >> bashfile, "perl ~tdo/Bin/nico.helper.trivial.pl "+self.runname+"/cigar1.tmp > "+self.runname+"/cigar1a.tmp"
#			print >> bashfile, "awk '{if ($1 == \"cigar::50\") print}' "+self.runname+"/cigar1a.tmp > "+self.runname+"/50_output.tmp"
#			print >> bashfile, "cd "+self.runname
#			#print >> bashfile, "/nfs/users/nfs_t/tdo/Bin/carma.Find.error.start.sh "+self.runname+"50_output.tmp 20 10000"
#			print >> bashfile, "/nfs/users/nfs_t/tdo/Bin/carma.Find.error.start.sh 50_output.tmp 20 10000"
#			print >> bashfile, "cd .."
#			print >> bashfile, "rm -f "+self.runname+"/cigar1a.tmp "+self.runname+"/50_output.tmp"
			...
			print >> bashfile, "/nfs/users/nfs_s/sh16/ssaha_2.2/pileup_v0.5/ssaha_pileup/ssaha_pileup/ssaha_clean -insert "+str(meaninsert)+" "+self.runname+"/cigar2unclean.tmp "+self.runname+"/cigar2.tmp"
			print >> bashfile, "awk '{print $2}' "+self.runname+"/cigar2.tmp > "+self.runname+"/readnames.tmp"
			...
			if rtype=='454':
				...
				print >> bashfile, "/nfs/users/nfs_s/sh16/ssaha_2.2/pileup_v0.5/ssaha_pileup/ssaha_pileup/ssaha_pileup -solexa 1 -trans 0 "+self.runname+"/cigar2.tmp "+ref+" "+self.runname+"/fastq.tmp > "+self.runname+"/snp.tmp"
				print >> bashfile, "/nfs/users/nfs_s/sh16/ssaha_2.2/pileup_v0.5/ssaha_pileup/ssaha_pileup/ssaha_pileup -cons 1 -solexa 1 -trans 0 "+self.runname+"/cigar2.tmp "+ref+" "+self.runname+"/fastq.tmp > "+self.runname+"/pileup.tmp"
			print >> bashfile, "egrep ^SNP "+self.runname+"/snp.tmp > "+self.runname+"/final.snp"
			print >> bashfile, "/nfs/users/nfs_s/sh16/ssaha_2.2/pileup_v0.5/ssaha_pileup/ssaha_pileup/ssaha_indel -insertion 1 "+self.runname+"/cigar2.tmp "+ref+" "+self.runname+"/pileup.tmp > "+self.runname+"/final.ins"
			print >> bashfile, "/nfs/users/nfs_s/sh16/ssaha_2.2/pileup_v0.5/ssaha_pileup/ssaha_pileup/ssaha_indel -deletion 1 "+self.runname+"/cigar2.tmp "+ref+" "+self.runname+"/pileup.tmp > "+self.runname+"/final.del"
			print >> bashfile, "egrep ^cons "+self.runname+"/pileup.tmp > "+self.runname+"/final.pileup"
