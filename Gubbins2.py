...
def main():
	...
	parser.add_option("-d", "--detectiontype", action="store", dest="detectiontype", type="choice", choices=["hmm", "movingwindow", "zip"], help="recombination detection method to use (choose from 'hmm', 'movingwindow') [default=%default]", default="movingwindow")
