...
#	os.system("mv "+prefix+"_iteration"+str(iteration)+".tre "+prefix+"_Final.tre")
	if options.reference=="":
		os.system("/nfs/pathogen/sh16_scripts/iCANDY.py -q taxa -t "+prefix+"_Final.tre -o "+prefix+"_Final_recomb "+prefix+"_rec.tab")
	else:
		os.system("/nfs/pathogen/sh16_scripts/iCANDY.py -q taxa -t "+prefix+"_Final.tre -o "+prefix+"_Final_recomb "+options.reference+" "+prefix+"_rec.tab")
