...
for file in inputfiles:
	...
	for line in lines:
		words=line.split('\n')
		if not sequences.has_key("_".join(words[0].split()[0].split("_")[:-1])):
			sequences["_".join(words[0].split()[0].split("_")[:-1])]=''
		sequences["_".join(words[0].split()[0].split("_")[:-1])]=sequences["_".join(words[0].split()[0].split("_")[:-1])]+''.join(words[1:])
		if "_".join(words[0].split()[0].split("_")[:-1])=="":
			print line
