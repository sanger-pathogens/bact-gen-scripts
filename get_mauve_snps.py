...
for inputfile in infiles:
	...
	if align!='':
		...
		os.system('progressiveMauve --output='+ref+'.mauvealn1 '+ref+' '+inputfile)
		...
		alnfile=open(prefix+'.mauvefna1','w')
	...
	alnfiles=alnfiles+' '+prefix+'.mauvefna1'
	#snpfiles.append(prefix+'.snps')


if align!='':
	print "Creating multiple alignment with Mauve..."
	os.system('progressiveMauve --output='+ref+'.mauvealn '+ref+' '+alnfiles)
